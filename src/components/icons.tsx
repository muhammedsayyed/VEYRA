...
export function BrainIcon({ size = 20, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M9.5 2A2.5 2.5 0 017 4.5v.5a2 2 0 01-2 2H4a2 2 0 00-2 2 2 2 0 002 2h1a2 2 0 012 2v.5a2.5 2.5 0 002.5 2.5 2.5 2.5 0 002.5-2.5V5A2.5 2.5 0 009.5 2z" />
      <path d="M14.5 2A2.5 2.5 0 0117 4.5v.5a2 2 0 002 2h1a2 2 0 012 2 2 2 0 01-2 2h-1a2 2 0 00-2 2v.5a2.5 2.5 0 01-2.5 2.5A2.5 2.5 0 0112 13V4.5A2.5 2.5 0 0114.5 2z" />
      <path d="M12 13v6" />
      <path d="M9.5 19H14.5" />
    </svg>
  )
...
export function StarIcon({ size = 20, className = "", filled = false, fill }: IconProps & { filled?: boolean; fill?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={fill ? fill : filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function Barcode2Icon({ size = 20, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className={className}>
      ...
      <line x1="9" y1="5" x2="9" y2="19" strokeWidth="3" />
