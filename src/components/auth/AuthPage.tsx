    ...
    <MotionConfig reducedMotion="user">
      <div className="min-h-[100dvh] w-full flex items-center justify-center p-3 sm:p-5 md:p-6 lg:p-8 relative overflow-hidden bg-[var(--veyra-paper)] selection:bg-[var(--veyra-ink)] selection:text-white">
        ...
        <div className="w-full max-w-[1080px] relative z-10 grid lg:grid-cols-[1.02fr_1.12fr] gap-5 sm:gap-6 lg:gap-7 items-center">
          {/* ── MOBILE — condensed identity strip ── */}
          <div className="lg:hidden flex items-center gap-3 px-1">
            <div
              className="w-10 h-10 rounded-[13px] flex items-center justify-center shrink-0 overflow-hidden"
              style={{ background: "var(--veyra-ink)", boxShadow: "0 4px 14px rgba(15,26,28,0.12)" }}
            >
              <img src={veyraLogo} alt="Veyra" className="w-6 h-6 object-contain brightness-0 invert" />
            </div>
            <div>
              <div className="font-display font-800 text-[15px] tracking-[-0.02em] text-[var(--veyra-ink)] leading-none">VEYRA</div>
              <div className="font-mono text-[9px] tracking-[0.15em] font-700 text-[var(--veyra-clay)] uppercase">Wellness AI</div>
            </div>
            <div className="ml-auto hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-white border border-[#E8E0D0] text-[10px] font-600 text-[#6B7280]">
          ...
          >
            ...
            <div className="relative z-10 flex items-center gap-3">
              <div className="w-10 h-10 rounded-[13px] bg-white flex items-center justify-center shadow-sm overflow-hidden">
                <img src={veyraLogo} alt="Veyra" className="w-6 h-6 object-contain" />
              </div>
              <div>
                <div className="font-display font-800 text-[15px] tracking-[-0.02em] text-white leading-none">VEYRA</div>
                <div className="font-mono text-[9px] tracking-[0.16em] font-700 text-[#E8B896] uppercase">Wellness Intelligence</div>
              </div>
          ...
          >
            ...
            <div className="relative p-5 sm:p-7 md:p-8">
              ...
              <div className="flex items-start gap-3.5 mb-6">
                <div
                  className="w-11 h-11 sm:w-12 sm:h-12 rounded-[14px] flex items-center justify-center shrink-0 overflow-hidden"
                  style={{
                    background: "#FFFFFF",
                    border: "1px solid #E8E0D0",
                    boxShadow: "0 4px 14px rgba(15,26,28,0.06)",
                  }}
                >
